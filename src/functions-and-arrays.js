...
// Bonus - Iteration #4.1
function avg(arr) {
  if (arr.length === 0) return null; // Devuelve null si el array está vacío
  ...
  return parseFloat((total / arr.length)); // Calcula el promedio y lo redondea a 2 decimales
}
...
function howManyTimes(wordsCount, word) {
  ...
  return wordsCount.reduce((count, currentWord) => currentWord === word ? count + 1 : count, 0)
